...
<script src="autocomplete/searchTransID.js"></script>
</head>
<body>
<div id="top">
...
<div id="container">
	...
	<div id="spacer">&nbsp;</div>
	<div id="profile">
		<center><font size="-1"><br />Enter the provided Transaction ID #</font>
		<div>&nbsp;</div>	
		<form action="search_results_TransactionTransID.php" method="post">
			<div class="dropdown">
