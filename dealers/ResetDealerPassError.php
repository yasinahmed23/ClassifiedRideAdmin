...
<div id="container">
	...
	<div id="spacer">&nbsp;</div>
	<div id="profile">
		<p align="center">That email address does not match our records.  Please try again.</p>
		<form id="Forgot_Password_Form" name="Change_Password_Form" method="post" action="includes/reset_Dealer_password_process.php">
