<div id="NewHireForm"><form id="DealerRegisterForm" name="DealerRegisterForm" method="post" action="includes/Dealer_Registration_process.php" onsubmit="return validateDealerForm()">
	...
	<tr valign="top">
		<td colspan="2"><font size="+1"><strong>Dealer Registration Form</strong></font></td>
				...
				<tr valign="top">
					...
					<br />
					<font size="-2"><div id="FormLableLeft">Password*</div><div id="FormLableRight">Re-Enter Password*</div><br /><div id="password_result">&nbsp;</div><font>
					<br />					
					</td>
				</tr>
				<tr valign="top">
				...
				<tr>
					...
					<td width="155"><input name="DealerStreet1" type="text" class="textfield" id="DealerStreet1" size="30" /><input name="DealerStreet2" type="text" class="textfield" id="DealerStreet2" size="30" /><br /><font size="-2"><div id="FormLableLeft">Street Address*</div><div id="FormLableStreetRight">Street Address Line 2</div></font></td>
			    	</tr>
				<tr><td>&nbsp;</td></tr>
				<tr>
					<td width="155">&nbsp;</td>
					...
					<input name="DealerState" type="text" class="textfield" id="DealerState" size="2" maxlength="2" /><br /><font size="-2"><div id="FormLableLeft">City*</div><div id="FormLableState">State/ Province /Region*</div></font>
					<br />
					</td>
			    	</tr>
			...
			<tr><td><br /></td></tr>
				<tr>
					...
					<br /><font size="-2"><div id="FormLableLeft">First*</div><div id="FormLableState">Last*</div></font>				
					</td>
			    	</tr>
				<tr><td>&nbsp;</td></tr>				
				<tr>
				...
				<tr>
					...
					<br />
						<font size="-2"><div id="FormLableLeft">Enter Email Address*</div><div id="FormLableEmailRight">Re-Enter Email Address*</div><br /><div id="email_result">&nbsp;</div><font>
					</td>
			    	</tr>
 	...
 	<td width="155">Main Contact Position</td>
				...
				<tr>
					...
					<td width="155">
						...
						<font size="-2"><div id="FormLableLeft">Enter Email Address*</div><div id="FormLableEmailRight">Re-Enter Email Address*</div><br /><div id="Payemail_result">&nbsp;</div><font>
					</td>
			    	</tr>
				<tr valign="top">
					<td width="155">&nbsp;</td>
				...
				<tr>
					...
					<br />
						<font size="-2"><div id="FormLableLeft">Enter Email Address*</div><div id="FormLableEmailRight">Re-Enter Email Address*</div><br /><div id="Leademail_result">&nbsp;</div></font>
					</td>
			    	</tr>
				<tr><td>&nbsp;</td></tr>
				...
				<tr><td><br /></td></tr>
					...
					<br />					
					<font size="-2">
					<font size="-2"><div id="FormLableLeft">First*</div><div id="FormLableState">Last*</div><br /><font>					
					</font>
					</td>
				</tr>
				<tr><td><br /></td></tr>
				...
				<tr>
					...
					<br /><font size="-2">Start Typing the employee's First Name to Search Database</font>
				...
				<tr valign="top">
					...
					<td>
						<input type="text" name="AgentFirstName" id="AgentFirstName" width="15" class="textfield" />
						<input type="text" name="AgentLastName" id="AgentLastName" width="15" class="textfield" />
						<br /><font size="-2"><div id="FormLableLeft">First*</div><div id="FormLableState">Last*</div></font>
						</td>
				</tr>
				<tr><td><br /></td></tr>
