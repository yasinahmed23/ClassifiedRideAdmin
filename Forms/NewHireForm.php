<div id="NewHireForm"><form id="RegisterForm" name="RegisterForm" method="post" action="/includes/New_Hire_process.php" onsubmit="return validateForm()">
			...
			<table width="700" border="0" align="center" cellpadding="0" cellspacing="0">
		    		<tr valign="top">
		        		<td colspan="2" ><font size="+1"><strong>New-Hire Employment Form</strong></font>
		            		<br />
		            		<font size="-1">We are excited that you will becoming part of the ClassifiedRide Training team! <br /><font size="-1">Please complete all fields so that you may gain access to the site.</font></font>
		            		<hr />
		            		</td>
		        	</tr>
			</table>
